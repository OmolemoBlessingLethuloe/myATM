...
{
    public abstract class myATMWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static myATMWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(myATMWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<myATMDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<myATMDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<myATMDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<myATMDbContext, Task<T>> func)
        {
            T result;
